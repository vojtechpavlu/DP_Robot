...
from src.fw.target.task import VisitSpecificFieldsTask, ApplyAllInteractions
...
class VisitingAllTargetFactory(TargetFactory):
    ...
    def build(self, world: "World") -> "Target":
        ...
        target.add_task(ApplyAllInteractions(
            ["ForwardMove", "CompassScan", "Not-existing-interaction"]
        ))
        return target
...
def _get_target_factory() -> "TargetFactory":
    ...
    return VisitingAllTargetFactory()
