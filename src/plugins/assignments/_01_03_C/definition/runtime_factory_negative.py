...
# Název úlohy
_TARGET_NAME = f"Robot nemá cestu k posunu"
...
_TARGET_DESCRIPTION = (
    ...
    f"kterou se máme vydat. V tomto případě je ovšem robot obklopen stěnami "
    f"a nemá východisko. Musí se tedy ukončit, protože nenašel řešení.")
...
class FirstInteractionTestFactory(TargetFactory):
    def build(self, world: "World", logger: "Logger") -> "Target":
        ...
        # Program se musí předčasně ukončit, protože úloha nemá řešení
        target.add_task(AbortedWith("FAILURE"))
