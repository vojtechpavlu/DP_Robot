...
_AVAILABLE_UNITS = ("ForwardMover", "IsWallSensor")
...
# Popis úlohy
_TARGET_DESCRIPTION = (
    f"Dvakrát měř... Cílem je, aby robot zaznamenal délku chodby, do níž je "
    f"na jednom konci zasazen.")
...
class AisleWalkerTestFactory(TargetFactory):
    def build(self, world: "World", logger: "Logger") -> "Target":
        ...
        target.add_task(LoggedMessageInContext("10"))
...
def _get_world_factory() -> "WorldFactory":
    ...
    return OpenSpaceWorldFactory(12, 3, _get_world_interface_factory(),
